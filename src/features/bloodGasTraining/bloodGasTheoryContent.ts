...
export const acidBaseMethodSteps = [
  ...
  {
    label: "5. Se på øvrige værdier",
    text: "Se på laktat, glukose, elektrolytter, nyretal og CRP.",
  },
  {
...
export const bloodGasPatterns: BloodGasPattern[] = [
  ...
  },
  {
    ...
    supportingValues: "Laktat, glukose, klorid, kalium og nyretal kan hjælpe med at beskrive mulige sammenhænge.",
  ...
  },
  {
    ...
    supportingValues: "Kalium, natrium, laktat, nyretal, ketonmåling hvis tilgængelig og klinisk kontekst er vigtige.",
  ...
  },
  {
    ...
    summary: "Et mønster med nyretal og elektrolytter som kan støtte mistanke om nyre- eller væskerelateret påvirkning.",
