...
import type { BackendCard } from "../src/types/BackendCards";
import type { Flashcard } from "../src/types/Flashcard";

// Convert full Flashcard -> slim BackendCard
export function toBackendCard(card: Flashcard, deckId?: string): BackendCard {
  const { image, ...serializableCard } = card;
  void image;
  return {
    ...serializableCard,
    ...(deckId ? { deckId } : {}),
